...
/** Real PHASE-11 / P014 Spring Boot + PostgreSQL 16 + Redis browser fixture. */
public final class Phase11P014BrowserBackendFixture {

  private static final UUID TENANT = uuid("00000000-0000-0000-0000-000000002024"),
      CENTER_A = uuid("10000000-0000-0000-0000-000000003524"),
      CENTER_B = uuid("10000000-0000-0000-0000-000000003525"),
      POSITION_A = uuid("20000000-0000-0000-0000-000000003524"),
      POSITION_B = uuid("20000000-0000-0000-0000-000000003525"),
      AFFECTED = uuid("30000000-0000-0000-0000-000000003524"),
      MANAGER = uuid("30000000-0000-0000-0000-000000003525"),
      INVESTIGATOR = uuid("30000000-0000-0000-0000-000000003526"),
      REVIEWER = uuid("30000000-0000-0000-0000-000000003527"),
      DECIDER = uuid("30000000-0000-0000-0000-000000003528"),
      APPEAL = uuid("30000000-0000-0000-0000-000000003529"),
      TECH = uuid("30000000-0000-0000-0000-000000003530"),
      OUTSIDER = uuid("30000000-0000-0000-0000-000000003531");
  private static final String API_PASSWORD = "p014_browser_api_" + shortId(),
      AUDIT_PASSWORD = "p014_browser_audit_" + shortId();

  private Phase11P014BrowserBackendFixture() {}

  public static void main(String[] args) throws Exception {
    String tenant = required("PHASE11_P014_TENANT"),
        managerLogin = required("PHASE11_P014_LOGIN"),
        password = required("PHASE11_P014_PASSWORD");
    ...
    System.out.println("PHASE11_P014_BROWSER_FIXTURE_READY");
    ...
    try (Connection c =
      ...
      s.execute(
          "insert into org.position(id,tenant_id,position_code,position_name,org_id,status) values"
              ...
              + CENTER_B
              + "','ACTIVE')");
      UUID[] actors = {AFFECTED, MANAGER, INVESTIGATOR, REVIEWER, DECIDER, APPEAL, TECH, OUTSIDER};
      ...
      String[][] roles = {
        {"phase11.p014.affected", "SELF", "p014.discipline.read,p014.discipline.appeal"},
        {managerLogin, "CENTER", "p014.discipline.read,p014.discipline.manage"},
        {"phase11.p014.investigator", "CENTER", "p014.discipline.read,p014.discipline.investigate"},
        {"phase11.p014.reviewer", "CENTER", "p014.discipline.read,p014.discipline.investigate"},
        {
          "phase11.p014.decider",
          "CENTER",
          "p014.discipline.read,p014.discipline.decide,p014.discipline.appeal"
        },
        {"phase11.p014.appeal", "CENTER", "p014.discipline.read,p014.discipline.appeal"},
        {"phase11.p014.tech", "CENTER", "p014.discipline.monitor"},
        {"phase11.p014.out", "CENTER", "p014.discipline.read"}
      };
  ...
  private static void seedActor(
    ...
    String roleCode = "P014_BROWSER_" + index;
    s.execute(
        "insert into"
  ...
  private static void writeFacts(PostgreSQLContainer<?> postgres, GenericContainer<?> redis)
    ...
    Path output =
        root()
            .resolve(
                "technical-platform/backend/apps/api/target/phase11-p014-fixture-runtime.json");
  ...
  private static UUID derived(int group, int index) {
    return uuid("%d0000000-0000-0000-0000-%012d".formatted(group, 3524 + index));
  }
