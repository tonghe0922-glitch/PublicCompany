...
/** Real PHASE-10 / P009 Spring Boot + PostgreSQL16 + Redis browser fixture. */
public final class Phase10P009BrowserBackendFixture {

  private static final UUID TENANT = uuid("00000000-0000-0000-0000-000000002029"),
      CENTER_A = uuid("10000000-0000-0000-0000-000000003229"),
      CENTER_B = uuid("10000000-0000-0000-0000-000000003230"),
      POS_A = uuid("20000000-0000-0000-0000-000000003229"),
      POS_B = uuid("20000000-0000-0000-0000-000000003230");
  private static final UUID EMPLOYEE = uuid("30000000-0000-0000-0000-000000003229"),
      MANAGER = uuid("30000000-0000-0000-0000-000000003230"),
      REVIEWER = uuid("30000000-0000-0000-0000-000000003231"),
      HR = uuid("30000000-0000-0000-0000-000000003232"),
      TECH = uuid("30000000-0000-0000-0000-000000003233"),
      OUT = uuid("30000000-0000-0000-0000-000000003234");
  private static final String API_PASSWORD = "p009_browser_api_" + shortId(),
      AUDIT_PASSWORD = "p009_browser_audit_" + shortId();

  private Phase10P009BrowserBackendFixture() {}

  public static void main(String[] args) throws Exception {
    String tenant = required("PHASE10_P009_TENANT"),
        managerLogin = required("PHASE10_P009_LOGIN"),
        password = required("PHASE10_P009_PASSWORD");
    ...
    System.out.println("PHASE10_P009_BROWSER_FIXTURE_READY");
  ...
  private static void seed(PostgreSQLContainer<?> p, String managerLogin, String password)
    ...
    try (Connection c =
      ...
      String[][] roles = {
        {"phase10.p009.employee", "SELF", "p009.overtime.submit,p009.overtime.read"},
        {managerLogin, "CENTER", "p009.overtime.read,p009.overtime.manage"},
        {"phase10.p009.reviewer", "CENTER", "p009.overtime.read,p009.overtime.review"},
        {"phase10.p009.hr", "CENTER", "p009.overtime.read,p009.overtime.hr"},
        {"phase10.p009.tech", "CENTER", "p009.overtime.monitor"},
        {"phase10.p009.out", "CENTER", "p009.overtime.read"}
      };
  ...
  private static void writeFacts(PostgreSQLContainer<?> p, GenericContainer<?> r) throws Exception {
    Path out =
        root()
            .resolve(
                "technical-platform/backend/apps/api/target/phase10-p009-fixture-runtime.json");
  ...
  private static UUID derived(int g, int i) {
    return uuid("%d0000000-0000-0000-0000-%012d".formatted(g, 3229 + i));
  }
