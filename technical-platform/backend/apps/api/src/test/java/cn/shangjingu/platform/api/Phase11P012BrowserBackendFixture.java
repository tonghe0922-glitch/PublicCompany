...
/** Real PHASE-11 / P012 Spring Boot + PostgreSQL 16 + Redis browser fixture. */
public final class Phase11P012BrowserBackendFixture {

  private static final UUID TENANT = uuid("00000000-0000-0000-0000-000000002022"),
      CENTER_A = uuid("10000000-0000-0000-0000-000000003422"),
      CENTER_B = uuid("10000000-0000-0000-0000-000000003423"),
      OLD_POSITION = uuid("20000000-0000-0000-0000-000000003422"),
      NEW_POSITION = uuid("20000000-0000-0000-0000-000000003423"),
      OUT_POSITION = uuid("20000000-0000-0000-0000-000000003424"),
      OWNER = uuid("30000000-0000-0000-0000-000000003422"),
      MANAGER = uuid("30000000-0000-0000-0000-000000003423"),
      ASSESSOR = uuid("30000000-0000-0000-0000-000000003424"),
      REVIEWER = uuid("30000000-0000-0000-0000-000000003425"),
      APPROVER = uuid("30000000-0000-0000-0000-000000003426"),
      APPOINTER = uuid("30000000-0000-0000-0000-000000003427"),
      TECH = uuid("30000000-0000-0000-0000-000000003428"),
      OUTSIDER = uuid("30000000-0000-0000-0000-000000003429");
  private static final String API_PASSWORD = "p012_browser_api_" + shortId(),
      AUDIT_PASSWORD = "p012_browser_audit_" + shortId();

  private Phase11P012BrowserBackendFixture() {}

  public static void main(String[] args) throws Exception {
    String tenant = required("PHASE11_P012_TENANT"),
        managerLogin = required("PHASE11_P012_LOGIN"),
        password = required("PHASE11_P012_PASSWORD");
    ...
    System.out.println("PHASE11_P012_BROWSER_FIXTURE_READY");
  ...
  private static void seed(PostgreSQLContainer<?> postgres, String managerLogin, String password)
    ...
    try (Connection c =
      ...
      String[][] roles = {
        {"phase11.p012.owner", "SELF", "p012.promotion.read"},
        {managerLogin, "CENTER", "p012.promotion.read,p012.promotion.manage"},
        {"phase11.p012.assessor", "CENTER", "p012.promotion.read,p012.promotion.review"},
        {"phase11.p012.reviewer", "CENTER", "p012.promotion.read,p012.promotion.review"},
        {"phase11.p012.approver", "CENTER", "p012.promotion.read,p012.promotion.approve"},
        {"phase11.p012.appointer", "CENTER", "p012.promotion.read,p012.promotion.appoint"},
        {"phase11.p012.tech", "CENTER", "p012.promotion.monitor"},
        {"phase11.p012.out", "CENTER", "p012.promotion.read"}
      };
  ...
  private static void seedActor(
    ...
    String roleCode = "P012_BROWSER_" + index;
    s.execute(
        "insert into"
  ...
  private static void writeFacts(PostgreSQLContainer<?> postgres, GenericContainer<?> redis)
    ...
    Path output =
        root()
            .resolve(
                "technical-platform/backend/apps/api/target/phase11-p012-fixture-runtime.json");
  ...
  private static UUID derived(int group, int index) {
    return uuid("%d0000000-0000-0000-0000-%012d".formatted(group, 3422 + index));
  }
