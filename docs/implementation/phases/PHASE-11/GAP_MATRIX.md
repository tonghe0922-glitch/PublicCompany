...
| Source contract | Preparation contract generated | C0 逐流程冻结 | PREPARED_NOT_FROZEN |
| Page bindings | P013 候选过宽；其余精确候选 0 | 物理 XLSX source_key + route 的人工冻结 | MISSING_C0 |
| Business API source | 0 records | 显式工程合同并标注非 XLSX 原始事实 | MISSING_C0 |
| Permission/data scope | 未冻结 | 每动作 action + data scope + field projection | MISSING_C0 |
| Workflow version | 未冻结 | published version/node/action/form contract | MISSING_C0 |
...
|---|---|---|---|---|---|---|---|---|---|
| P011 绩效管理 | EXISTING | MISSING | MISSING | MISSING | MISSING | MISSING | MISSING | 领域规则完整性、联动 S11、页面 0 候选、HTTP/permission/workflow | **P011 C0 freeze** |
