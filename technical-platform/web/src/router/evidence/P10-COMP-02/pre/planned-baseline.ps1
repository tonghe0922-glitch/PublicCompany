...
$plannedPaths = @(
    ...
    'technical-platform/web/src/router/portal-router.test.ts',
    ...
    'technical-platform/web/src/design-system/templates/PageTemplateFrame.vue',
    'technical-platform/web/src/design-system/templates/ApprovalPageTemplate.vue',
    'technical-platform/web/src/design-system/templates/DashboardPageTemplate.vue',
    'technical-platform/web/src/design-system/templates/DetailPageTemplate.vue',
    'technical-platform/web/src/design-system/templates/FormPageTemplate.vue',
    'technical-platform/web/src/design-system/templates/ListPageTemplate.vue',
    'technical-platform/web/src/design-system/templates/TimelinePageTemplate.vue',
    'technical-platform/web/src/design-system/templates/PageTemplateFrame.test.ts',
    'technical-platform/web/src/design-system/layout/PortalShell.landmark.test.ts',
    'technical-platform/web/src/platform/pages/P001IdentityPage.vue',
    'technical-platform/web/src/platform/pages/P002PermissionRequestPage.vue',
    'technical-platform/web/src/platform/pages/P003ProfileChangePage.vue',
    'technical-platform/web/src/platform/pages/P004GenericRequestPage.vue',
    'technical-platform/web/src/platform/pages/P005NoticePage.vue',
    'technical-platform/web/src/platform/pages/P006MeetingPage.vue',
    'technical-platform/web/src/platform/pages/P007SchedulePage.vue',
    ...
    'technical-platform/web/src/platform/pages/Phase10AttendanceMonitorPage.vue',
    'technical-platform/web/src/platform/pages/ForbiddenPage.vue',
    'technical-platform/web/src/platform/pages/P001IdentityPage.ui-plan.json',
    'technical-platform/web/src/platform/pages/P002PermissionRequestPage.ui-plan.json',
    'technical-platform/web/src/platform/pages/P003ProfileChangePage.ui-plan.json',
    'technical-platform/web/src/platform/pages/P004GenericRequestPage.ui-plan.json',
    'technical-platform/web/src/platform/pages/P005NoticePage.ui-plan.json',
    'technical-platform/web/src/platform/pages/P006MeetingPage.ui-plan.json',
    'technical-platform/web/src/platform/pages/P007SchedulePage.ui-plan.json',
    'technical-platform/web/src/platform/pages/P008LeavePage.ui-plan.json',
    'technical-platform/web/src/platform/pages/P009OvertimePage.ui-plan.json',
    'technical-platform/web/src/platform/pages/P010LearningPage.ui-plan.json',
    'technical-platform/web/src/platform/pages/Phase09CenterInboxPage.ui-plan.json',
    'technical-platform/web/src/platform/pages/Phase09TechWorkflowMonitorPage.ui-plan.json',
    'technical-platform/web/src/platform/pages/Phase10AttendanceMonitorPage.ui-plan.json',
    'technical-platform/web/src/platform/pages/ForbiddenPage.ui-plan.json'
)
...
$manifest = [ordered]@{
    schema_version = '1.0'
    kind = 'P10-COMP-02-pre-claim-baseline'
