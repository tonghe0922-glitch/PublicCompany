...
| P010 | 学习任务、考试、实操、资格 | 发布/指派、认证、资格、权限联动 | workflow/permission audit；无业务认证权 | learning namespace; read/manage/complete/exam/certify/monitor | LearningQualificationService + permission-link executor + JDBC | `learning.learning_assignment`; use existing score/practical/qualification fields; additive only if missing history facts | published P010 S01–S10 | assignment/exam/practical/certification/expiry/permission-link events | score 0–1000, practical separation, tech no-certify, expiry, idempotency, 3-portal E2E |
