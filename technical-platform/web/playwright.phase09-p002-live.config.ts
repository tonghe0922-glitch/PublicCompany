...
const servers = [
  ...
  { command: 'pnpm vite --mode admin --host 127.0.0.1 --port 5286 --strictPort', url: 'http://127.0.0.1:5286/admin.html' },
]
...
export default defineConfig({
  ...
  webServer: servers.map((server) => ({
    ...server,
    env: { SJG_LOCAL_API_PROXY_TARGET: 'http://127.0.0.1:18082' },
