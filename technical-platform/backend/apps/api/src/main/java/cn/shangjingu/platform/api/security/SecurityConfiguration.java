    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http,OpaqueAccessTokenFilter opaqueAccessTokenFilter,SecurityProblemHandler problemHandler)throws Exception{
        http.csrf(csrf->csrf.disable()).httpBasic(x->x.disable()).formLogin(x->x.disable()).logout(x->x.disable()).requestCache(x->x.disable())
                ...
                .authorizeHttpRequests(authorize->authorize
                        ...
                        .requestMatchers("/api/v1/processes/P006/**").authenticated()
                        .requestMatchers("/api/v1/processes/P007/**").authenticated()
                        .requestMatchers("/api/v1/processes/P008/**").authenticated()
                        .requestMatchers("/api/v1/processes/P009/**").authenticated()
                        .requestMatchers("/api/v1/processes/P010/**").authenticated()
                        .requestMatchers("/api/v1/processes/P011/**").authenticated()
                        .requestMatchers("/api/v1/processes/P012/**").authenticated()
                        .requestMatchers("/api/v1/processes/P013/**").authenticated()
                        .requestMatchers("/api/v1/processes/P014/**").authenticated()
                        .requestMatchers("/api/v1/processes/P015/**").authenticated()
                        .requestMatchers("/api/v1/processes/P016/**").authenticated()
