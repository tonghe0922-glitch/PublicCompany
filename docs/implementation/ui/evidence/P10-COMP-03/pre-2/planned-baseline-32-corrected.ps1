...
$legacy = Join-Path $OutputDirectory 'legacy-31'
$legacyScript = Join-Path $root 'docs/implementation/ui/evidence/P10-COMP-03/pre-claim/planned-baseline.ps1'
...
$relative = 'technical-platform/web/src/design-system/ui-component-access.test.ts'
...
$manifest.kind = 'P10-COMP-03-fresh-pre-2-baseline'
