...
/** Real PHASE-10 / P007 Spring Boot + PostgreSQL16 + Redis browser fixture. */
public final class Phase10P007BrowserBackendFixture {

  private static final UUID TENANT = uuid("00000000-0000-0000-0000-000000002027"),
      CENTER_A = uuid("10000000-0000-0000-0000-000000003027"),
      CENTER_B = uuid("10000000-0000-0000-0000-000000003028"),
      POS_A = uuid("20000000-0000-0000-0000-000000003027"),
      POS_B = uuid("20000000-0000-0000-0000-000000003028");
  private static final UUID MANAGER = uuid("30000000-0000-0000-0000-000000003027"),
      EMPLOYEE = uuid("30000000-0000-0000-0000-000000003028"),
      REVIEWER = uuid("30000000-0000-0000-0000-000000003029"),
      TECH = uuid("30000000-0000-0000-0000-000000003030"),
      OUT = uuid("30000000-0000-0000-0000-000000003031");
  private static final String API_PASSWORD = "p007_browser_api_" + shortId(),
      AUDIT_PASSWORD = "p007_browser_audit_" + shortId();

  private Phase10P007BrowserBackendFixture() {}

  public static void main(String[] args) throws Exception {
    String tenant = required("PHASE10_P007_TENANT"),
        managerLogin = required("PHASE10_P007_LOGIN"),
        password = required("PHASE10_P007_PASSWORD");
    ...
    System.out.println("PHASE10_P007_BROWSER_FIXTURE_READY");
  ...
  private static void seed(PostgreSQLContainer<?> p, String managerLogin, String password)
    ...
    try (Connection c =
      ...
      String[][] actors = {
        {managerLogin, "CENTER", "p007.schedule.read,p007.schedule.manage"},
        {"phase10.p007.employee", "SELF", "p007.schedule.read,p007.schedule.change"},
        {"phase10.p007.reviewer", "CENTER", "p007.schedule.read,p007.schedule.review"},
        {"phase10.p007.tech", "CENTER", "p007.schedule.monitor"},
        {"phase10.p007.out", "CENTER", "p007.schedule.read"}
      };
  ...
  private static void writeFacts(PostgreSQLContainer<?> p, GenericContainer<?> r) throws Exception {
    Path out =
        root()
            .resolve(
                "technical-platform/backend/apps/api/target/phase10-p007-fixture-runtime.json");
  ...
  private static UUID derived(int g, int i) {
    return uuid("%d0000000-0000-0000-0000-%012d".formatted(g, 3027 + i));
  }
