...
/** Real PHASE-11 / P013 Spring Boot + PostgreSQL 16 + Redis browser fixture. */
public final class Phase11P013BrowserBackendFixture {

  private static final UUID TENANT = uuid("00000000-0000-0000-0000-000000002023"),
      CENTER_A = uuid("10000000-0000-0000-0000-000000003523"),
      CENTER_B = uuid("10000000-0000-0000-0000-000000003524"),
      POSITION_A = uuid("20000000-0000-0000-0000-000000003523"),
      POSITION_B = uuid("20000000-0000-0000-0000-000000003524"),
      OWNER = uuid("30000000-0000-0000-0000-000000003523"),
      MANAGER = uuid("30000000-0000-0000-0000-000000003524"),
      REVIEWER_ONE = uuid("30000000-0000-0000-0000-000000003525"),
      REVIEWER_TWO = uuid("30000000-0000-0000-0000-000000003526"),
      APPROVER = uuid("30000000-0000-0000-0000-000000003527"),
      EXECUTOR = uuid("30000000-0000-0000-0000-000000003528"),
      TECH = uuid("30000000-0000-0000-0000-000000003529"),
      OUTSIDER = uuid("30000000-0000-0000-0000-000000003530");
  private static final String API_PASSWORD = "p013_browser_api_" + shortId(),
      AUDIT_PASSWORD = "p013_browser_audit_" + shortId();

  private Phase11P013BrowserBackendFixture() {}

  public static void main(String[] args) throws Exception {
    String tenant = required("PHASE11_P013_TENANT"),
        managerLogin = required("PHASE11_P013_LOGIN"),
        password = required("PHASE11_P013_PASSWORD");
    ...
    System.out.println("PHASE11_P013_BROWSER_FIXTURE_READY");
  ...
  private static void seed(PostgreSQLContainer<?> postgres, String managerLogin, String password)
    ...
    try (Connection c =
      ...
      String[][] roles = {
        {"phase11.p013.owner", "SELF", "p013.reward.read"},
        {managerLogin, "CENTER", "p013.reward.read,p013.reward.manage"},
        {"phase11.p013.reviewer1", "CENTER", "p013.reward.read,p013.reward.review"},
        {"phase11.p013.reviewer2", "CENTER", "p013.reward.read,p013.reward.review"},
        {"phase11.p013.approver", "CENTER", "p013.reward.read,p013.reward.approve"},
        {"phase11.p013.executor", "CENTER", "p013.reward.read,p013.reward.execute"},
        {"phase11.p013.tech", "CENTER", "p013.reward.monitor"},
        {"phase11.p013.out", "CENTER", "p013.reward.read"}
      };
  ...
  private static void seedActor(
    ...
    String roleCode = "P013_BROWSER_" + index;
    s.execute(
        "insert into"
  ...
  private static void writeFacts(PostgreSQLContainer<?> postgres, GenericContainer<?> redis)
    ...
    Path output =
        root()
            .resolve(
                "technical-platform/backend/apps/api/target/phase11-p013-fixture-runtime.json");
  ...
  private static UUID derived(int group, int index) {
    return uuid("%d0000000-0000-0000-0000-%012d".formatted(group, 3523 + index));
  }
