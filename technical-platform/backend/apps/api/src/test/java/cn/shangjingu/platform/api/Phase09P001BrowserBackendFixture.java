...
public final class Phase09P001BrowserBackendFixture {
    ...
    private static final String API_PASSWORD = "phase09_api_" + UUID.randomUUID().toString().replace("-", "");
    private static final String AUDIT_PASSWORD = "phase09_audit_" + UUID.randomUUID().toString().replace("-", "");
    ...
    private static void prepareDatabases(
        ...
        Flyway.configure()
                ...
                .placeholders(Map.of(
                        ...
                        "sjg_tenant_name", "PHASE09 P001 Browser Tenant"))
                .cleanDisabled(true)
                .load()
                .migrate();
        Flyway.configure()
    ...
    private static void seedSyntheticFacts(
        ...
        try (Connection connection = DriverManager.getConnection(
             ...
             Statement statement = connection.createStatement()) {
            statement.execute("INSERT INTO org.organization(id,tenant_id,org_code,org_name,org_type,path,status) VALUES ('" + CENTER_A + "','" + TENANT + "','PHASE09_P001_CENTER_A','Synthetic P001 Center A','CENTER','phase09_p001_center_a'::ltree,'ACTIVE'),('" + CENTER_B + "','" + TENANT + "','PHASE09_P001_CENTER_B','Synthetic P001 Center B','CENTER','phase09_p001_center_b'::ltree,'ACTIVE')");
            statement.execute("INSERT INTO org.position(id,tenant_id,position_code,position_name,org_id,status) VALUES ('" + POSITION_A + "','" + TENANT + "','PHASE09_P001_POS_A','Synthetic P001 Position A','" + CENTER_A + "','ACTIVE'),('" + POSITION_B + "','" + TENANT + "','PHASE09_P001_POS_B','Synthetic P001 Position B','" + CENTER_B + "','ACTIVE')");
            statement.execute("INSERT INTO org.employee(id,tenant_id,employee_no,person_name,employment_status,hire_date,primary_org_id,primary_position_id) VALUES ('" + MONITOR_EMPLOYEE + "','" + TENANT + "','P001-E001','P001 Monitor User','ACTIVE',current_date-10,'" + CENTER_A + "','" + POSITION_A + "'),('" + TARGET_EMPLOYEE + "','" + TENANT + "','P001-E002','P001 Same Center Target','ACTIVE',current_date-10,'" + CENTER_A + "','" + POSITION_A + "'),('" + OUT_EMPLOYEE + "','" + TENANT + "','P001-E003','P001 Cross Center Target','ACTIVE',current_date-10,'" + CENTER_B + "','" + POSITION_B + "')");
            statement.execute("INSERT INTO org.employee_position(id,tenant_id,employee_id,position_id,org_id,is_primary,effective_start_date,status) VALUES ('" + MONITOR_APPOINTMENT + "','" + TENANT + "','" + MONITOR_EMPLOYEE + "','" + POSITION_A + "','" + CENTER_A + "',true,current_date-10,'ACTIVE'),('" + TARGET_APPOINTMENT + "','" + TENANT + "','" + TARGET_EMPLOYEE + "','" + POSITION_A + "','" + CENTER_A + "',true,current_date-10,'ACTIVE'),('" + OUT_APPOINTMENT + "','" + TENANT + "','" + OUT_EMPLOYEE + "','" + POSITION_B + "','" + CENTER_B + "',true,current_date-10,'ACTIVE')");
            statement.execute("INSERT INTO iam.user_account(id,tenant_id,login_name,password_hash,status,mfa_level) VALUES ('" + MONITOR_USER + "','" + TENANT + "','" + monitorLogin + "','" + passwordHash + "','ACTIVE',0),('" + TARGET_USER + "','" + TENANT + "','" + TARGET_LOGIN + "','" + passwordHash + "','ACTIVE',0),('" + OUT_USER + "','" + TENANT + "','" + OUT_LOGIN + "','" + passwordHash + "','ACTIVE',0)");
            statement.execute("INSERT INTO iam.user_identity(id,tenant_id,user_id,employee_id,identity_type,identity_name,org_id,position_id,is_primary,effective_start_at) VALUES ('" + MONITOR_IDENTITY + "','" + TENANT + "','" + MONITOR_USER + "','" + MONITOR_EMPLOYEE + "','EMPLOYEE','P001 Monitor Identity','" + CENTER_A + "','" + POSITION_A + "',true,now()-interval '1 day'),('" + TARGET_IDENTITY + "','" + TENANT + "','" + TARGET_USER + "','" + TARGET_EMPLOYEE + "','EMPLOYEE','P001 Same Center Target','" + CENTER_A + "','" + POSITION_A + "',true,now()-interval '1 day'),('" + OUT_IDENTITY + "','" + TENANT + "','" + OUT_USER + "','" + OUT_EMPLOYEE + "','EMPLOYEE','P001 Cross Center Target','" + CENTER_B + "','" + POSITION_B + "',true,now()-interval '1 day')");
            statement.execute("INSERT INTO iam.data_scope_rule(tenant_id,scope_code,scope_name,rule_expr,enabled) VALUES ('" + TENANT + "','PHASE09_P001_CENTER','P001 Center Scope','{\"scope\":\"CENTER\"}'::jsonb,true),('" + TENANT + "','PHASE09_P001_SELF','P001 Self Scope','{\"scope\":\"SELF\"}'::jsonb,true)");
            statement.execute("INSERT INTO iam.role(id,tenant_id,role_code,role_name,role_type,data_scope_code,enabled) VALUES ('" + MONITOR_ROLE + "','" + TENANT + "','PHASE09_P001_MONITOR','P001 Monitor Role','PLATFORM','PHASE09_P001_CENTER',true),('" + TARGET_ROLE + "','" + TENANT + "','PHASE09_P001_TARGET','P001 Target Role','PLATFORM','PHASE09_P001_SELF',true),('" + OUT_ROLE + "','" + TENANT + "','PHASE09_P001_OUT','P001 Out Role','PLATFORM','PHASE09_P001_SELF',true)");
            statement.execute("INSERT INTO iam.permission(id,tenant_id,permission_code,permission_name,resource_type,action_code,risk_level) VALUES ('" + PERMISSION_READ + "','" + TENANT + "','platform.session.read','Read current session','SESSION','READ','NORMAL'),('" + PERMISSION_LOGOUT + "','" + TENANT + "','platform.session.logout','Logout current session','SESSION','LOGOUT','NORMAL'),('" + PERMISSION_MONITOR + "','" + TENANT + "','p001.session.monitor','Monitor P001 sessions','SESSION','MONITOR','HIGH')");
            statement.execute("INSERT INTO iam.role_permission(tenant_id,role_id,permission_id) VALUES ('" + TENANT + "','" + MONITOR_ROLE + "','" + PERMISSION_READ + "'),('" + TENANT + "','" + MONITOR_ROLE + "','" + PERMISSION_LOGOUT + "'),('" + TENANT + "','" + MONITOR_ROLE + "','" + PERMISSION_MONITOR + "'),('" + TENANT + "','" + TARGET_ROLE + "','" + PERMISSION_READ + "'),('" + TENANT + "','" + TARGET_ROLE + "','" + PERMISSION_LOGOUT + "'),('" + TENANT + "','" + OUT_ROLE + "','" + PERMISSION_READ + "'),('" + TENANT + "','" + OUT_ROLE + "','" + PERMISSION_LOGOUT + "')");
            statement.execute("INSERT INTO iam.user_role(tenant_id,user_id,identity_id,role_id,effective_start_at,grant_source) VALUES ('" + TENANT + "','" + MONITOR_USER + "','" + MONITOR_IDENTITY + "','" + MONITOR_ROLE + "',now()-interval '1 day','TEST_ONLY'),('" + TENANT + "','" + TARGET_USER + "','" + TARGET_IDENTITY + "','" + TARGET_ROLE + "',now()-interval '1 day','TEST_ONLY'),('" + TENANT + "','" + OUT_USER + "','" + OUT_IDENTITY + "','" + OUT_ROLE + "',now()-interval '1 day','TEST_ONLY')");
        }
    }
    ...
    private static void writeRuntimeFacts(
        ...
        Path output = findRepoRoot().resolve("technical-platform/backend/apps/api/target/phase09-p001-fixture-runtime.json");
        String json = "{\n"
